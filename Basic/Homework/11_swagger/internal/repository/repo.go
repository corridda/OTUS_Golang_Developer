...
import (
	...
	"github.com/corridda/OTUS_Golang_Developer/Basic/Homework/11_swagger/internal/model"
...
func (h *Handler) GetTasksById() gin.HandlerFunc {
	return func(c *gin.Context) {
...
func (h *Handler) GetNotesById() gin.HandlerFunc {
	return func(c *gin.Context) {
...
func (h *Handler) PostNewTask() gin.HandlerFunc {
	return func(c *gin.Context) {
		newTask := NewTask{}
...
func (h *Handler) PostNewNote() gin.HandlerFunc {
	return func(c *gin.Context) {
		newNote := NewNote{}
...
func (h *Handler) PutTaskById() gin.HandlerFunc {
	return func(c *gin.Context) {
		var taskId RemindableId
		if err := c.ShouldBindWith(&taskId, binding.Query); err == nil {
			idx := slices.IndexFunc(Tasks, func(task model.Task) bool {
...
func (h *Handler) PutNoteById() gin.HandlerFunc {
	return func(c *gin.Context) {
		var noteId RemindableId
		if err := c.ShouldBindWith(&noteId, binding.Query); err == nil {
			idx := slices.IndexFunc(Notes, func(note model.Note) bool {
...
func (h *Handler) DeleteTaskById() gin.HandlerFunc {
	return func(c *gin.Context) {
		var taskId RemindableId
		if err := c.ShouldBindWith(&taskId, binding.Query); err == nil {
			idx := slices.IndexFunc(Tasks, func(task model.Task) bool {
...
func (h *Handler) DeleteNoteById() gin.HandlerFunc {
	return func(c *gin.Context) {
		var noteId RemindableId
		if err := c.ShouldBindWith(&noteId, binding.Query); err == nil {
			idx := slices.IndexFunc(Notes, func(note model.Note) bool {
...
func InitHandler(r *gin.Engine, h *Handler) {

	api := r.Group("/api")
	apiTasks := api.Group("/tasks")
	apiNotes := api.Group("/notes")
	apiTasks.GET("items", h.GetTasks())            // /api/tasks/items
	apiTasks.GET("item/id", h.GetTasksById())      // /api/tasks/item/id/?id=<id_integer_number>
	apiNotes.GET("items", h.GetNotes())            // /api/notes/items
	apiNotes.GET("item/id", h.GetNotesById())      // /api/notes/item/id/?id=<id_integer_number>
	apiTasks.POST("item", h.PostNewTask())         // /api/tasks/item
	apiNotes.POST("item", h.PostNewNote())         // /api/tasks/item
	apiTasks.PUT("item/id", h.PutTaskById())       // /api/tasks/item/id/?id=<id_integer_number>
	apiNotes.PUT("item/id", h.PutNoteById())       // /api/notes/item/id/?id=<id_integer_number>
	apiTasks.DELETE("item/id", h.DeleteTaskById()) // /api/tasks/item/id/?id=<id_integer_number>
	apiNotes.DELETE("item/id", h.DeleteNoteById()) // /api/notes/item/id/?id=<id_integer_number>
}
